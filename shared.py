...
parser.add_argument("--no-half", default = True,action='store_true', help="do not switch the model to 16-bit floats")
...
parser.add_argument("--share", action='store_true',default=True, help="use share=True for gradio and make the UI accessible through their site (doesn't work for me but you might have better luck)")
